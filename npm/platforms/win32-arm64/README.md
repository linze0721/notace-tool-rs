# @not-ace-tool-rs/win32-arm64

Platform-specific binary for not-ace-tool-rs (Windows ARM64).

## Overview

This package contains the pre-built binary for Windows ARM64. It is automatically installed as an optional dependency when you run `npx not-ace-tool-rs` on Windows ARM64 systems.
